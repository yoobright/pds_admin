...
function genAdverseReactionText(strInput) {
    ...
    for (const input of inputList) {
       if (input in adverseReactionDict) {
           res.push(adverseReactionDict[input]);
       }
    }
    return res.join("、");
}
...
layui.use(["form", "table"], function () {
    ...
    function setPrevMedication(prevMedication) {
        ...
        $("[name='adverse_reaction']").val(
            genAdverseReactionText(prevMedication.adverse_reaction));
